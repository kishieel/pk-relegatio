      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="200" className="mb-3.5">
              <path
                fill="white"
            ...
            <h3 className="pb-2 pt-4 text-2xl font-bold leading-8 tracking-tight">Relegation</h3>
            <div className="text-gray-500 dark:text-gray-400">Unpopular opinions on popular topics</div>
          </div>
          <div className="prose max-w-none pb-8 pt-8 dark:prose-invert xl:col-span-2">
            <p className="mb-5">
              Relegation isn't your average blog. We're all about shaking things up by exploring unpopular opinions on
            ...
            <p className="mb-5">
              Diversity is key at Relegation. Our team brings together a range of backgrounds and viewpoints, ensuring
            ...
            <p className="mb-5">
              Ready to join the conversation? Whether you're a seasoned skeptic or just curious, Relegation welcomes you

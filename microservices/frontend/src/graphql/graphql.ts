...
export type PostPaginationPageInfo = {
  __typename?: 'PostPaginationPageInfo';
...
export type PostByIdQuery = {
  ...
  post: {
    ...
    createdAt: any;
    updatedAt: any;
    author: { __typename?: 'Author'; id: any; firstName: string; lastName: string; createdAt: any; updatedAt: any };
  };
};
...
export type PostsQuery = {
  ...
  posts: {
    ...
    pageInfo: { __typename?: 'PostPaginationPageInfo'; hasNextPage: boolean; hasPrevPage: boolean };
  };
};
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'Cuid' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<PostByIdQuery, PostByIdQueryVariables>;
